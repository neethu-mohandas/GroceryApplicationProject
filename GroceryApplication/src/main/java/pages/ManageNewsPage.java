...
public class ManageNewsPage {
	...
	@FindBy(id = "news")
	private WebElement enternewstextarea;
	...
	private WebElement newssearchsubmit;
	@FindBy(xpath = "//a[@class='btn btn-rounded btn-warning']")
	private WebElement resetnewsbutton;

	// assertion elements
	// @FindBy(xpath="//h5[text()=' Alert!']") private WebElement addnewssuccess;
	@FindBy(xpath = "//div[@class='alert alert-success alert-dismissible']")
	private WebElement newssuccessalerts;
	@FindBy(xpath = "//table[@class='table table-bordered table-hover table-sm']//tbody/tr[1]/td[1]")
	private WebElement newssearchresulttable;
	...
	/*
	 * public boolean successNewsDisplayed() { return addnewssuccess.isDisplayed();
	 * }
	 */
