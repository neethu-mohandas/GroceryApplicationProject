...
public class AdminUsersTest extends Base {
	...
	public void verifyUserAbleToAddNewUser() throws IOException {
		...
		Assert.assertTrue(adminuserssuccessmessage.contains("User Created Successfully"),
				Constants.ADDNEWADMINUSERERROR);
	}
	...
	public void verifyUserAbleToSearchNewlyAddedUser() throws IOException {
		...
		adminuserspage.clickOnSearch().enterSearchUsername(searchUsername).selectSearchUserType()
				.clickOnSearchAdminUser();
