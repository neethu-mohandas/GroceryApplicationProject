...
public class LoginTest extends Base {
	...
	@Test(groups = {
			"smoke" }, priority = 1, description = "User login using valid username and valid password", retryAnalyzer = retry.Retry.class)
	...
	@Test(groups = {
			"smoke" }, priority = 4, description = "User login using invalid username and invalid password", dataProvider = "loginProvider")
	public void verifyLoginWithInvalidCredentials(String usernameValue, String passwordValue) throws IOException {
		...
		// //commenting since taking data from dataProvider
